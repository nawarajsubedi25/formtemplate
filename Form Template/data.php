 ...
 ********************************************************************************************/
        ...
        $url = "https://maps.googleapis.com/maps/api/geocode/json?address=$city,$state,$zipcode,$country&key=AIzaSyCU4yvm6WqECdThPvsg-678iJ0O9lNiJ8E";
...
**********************************************************************************/
   ...
   $row = $result->fetch_assoc();
    if($row["Vcount"] ==0)
        ...
        {
            $count=$row["Vcount"]+1;
            $query="UPDATE STATELATLONG SET Vcount=$count WHERE Fname='$firstname' AND Lname='$lastname' AND  Zipcode='$zipcode' AND City='$city'";
            $raj->insertDatabase($query);
        }
